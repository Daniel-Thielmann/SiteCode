...
export default function AboutUsIII() {
    const pagination = {
        ...
        renderBullet: function (index: number, className: string) {
            return '<span style="background-color: white; border: 1px solid white; width: 14px; height: 14px;" class="' + className + '"></span>';
        },
    };
    return (
        <div className="pt-[72px] flex flex-col items-center gap-12 justify-center pb-[72px]">
            <h2 className="sub-titulo text-center text-[30px] bp-500:text-[40px] text-subtitulo">Movimento empresa júnior</h2>
            <div className="flex bp-1024:flex-row flex-col-reverse w-full justify-around items-center bp-1024:gap-24 gap-5 pl-[5%] pr-[5%]">
                ...
                <div>
                    ...
                    >
                        <SwiperSlide><Image height={406} width={422} src={'/Carrossel.svg'} alt="Nature 1" /></SwiperSlide>
                        <SwiperSlide><Image height={406} width={422} src={'/Carrossel.svg'} alt="Nature 1" /></SwiperSlide>
                        <SwiperSlide><Image height={406} width={422} src={'/Carrossel.svg'} alt="Nature 1" /></SwiperSlide>
                        <SwiperSlide><Image height={406} width={422} src={'/Carrossel.svg'} alt="Nature 1" /></SwiperSlide>
                        <SwiperSlide><Image height={406} width={422} src={'/Carrossel.svg'} alt="Nature 1" /></SwiperSlide>
